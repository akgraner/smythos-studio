  ...
  protected async init() {
    ...
    this.settings = {
      formatting_mode: {
        ...
        help: 'Turn on headings, lists, links, and code formatting. Processes content in Markdown format for notes, headings, lists, and styled text instead of plain text.',
        tooltipClasses: 'w-56 ',
        arrowClasses: '-ml-11',
        hintPosition: 'bottom',
        events: {
      ...
      content: {
        ...
        help: 'Store note content for context, decisions, and next steps.',
        tooltipClasses: 'w-40',
        arrowClasses: '-ml-11',
        hintPosition: 'bottom',
      ...
      textColor: {
        ...
        help: 'Set text color for readability and clear grouping.',
        tooltipClasses: 'w-56 ',
        arrowClasses: '-ml-11',
        hintPosition: 'bottom',
        events: {
      ...
      color: {
        ...
        help: 'Pick a background color to label or highlight sections.',
        tooltipClasses: 'w-56 ',
        arrowClasses: '-ml-11',
        events: {
          change: (e) => {
