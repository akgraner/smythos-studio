...
export class Outpainting extends Component {
  ...
  protected async init() {
    ...
    this.drawSettings.displayName = 'Outpainting';
    this.drawSettings.iconCSSClass = 'svg-icon ' + this.constructor.name;

    this.drawSettings.componentDescription = 'Extend your image beyond its original borders.';
    this.drawSettings.shortDescription = 'Extend your image beyond its original borders.';
