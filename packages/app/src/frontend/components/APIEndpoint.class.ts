...
export class APIEndpoint extends Component {
  ...
  private getSkillErrors() {
    ...
    this.workspace.jsPlumbInstance.bind('connection', _.debounce(checkConnections, 100));
    this.workspace.jsPlumbInstance.bind('connectionDetached', _.debounce(checkConnections, 100));
