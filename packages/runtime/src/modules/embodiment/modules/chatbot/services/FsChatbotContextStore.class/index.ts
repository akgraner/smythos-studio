...
import { EStorageTypes } from '@core/types/fileStorage.types';
import type { ILLMContextStore } from 'smyth-runtime';
...
export class FsChatbotContextStore implements ILLMContextStore {
    ...
    public async getMessage(message_id: string): Promise<Record<string, any>> {
        return {};
    }
